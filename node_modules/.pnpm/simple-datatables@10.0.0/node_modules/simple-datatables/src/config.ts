...
export const defaultConfig: DataTableConfiguration = {
    ...
    labels: {
        placeholder: "Buscar CURP", // The search input placeholder
        ...
        noResults: "No se encontraron resultados", // Message shown when there are no search results
        info: "Mostrar {start} a {end} de {rows} entradas" //
    },
